...
describe('Lottery Contract', () => {
    ...
    it('only menager can call pickWinner', async() => {
        try {
    ...
    it('send money to the winner an resets the players array', async() => {
        await lottery.methods.enter().send({
            from: accounts[0],
    ...
    it('total awards', async () => {
        await lottery.methods.premiumValue().call()
    });
});